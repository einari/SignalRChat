    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies.chat.server = {
            createChatRoom: function (room) {
                /// <summary>Calls the CreateChatRoom method on the server-side Chat hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                /// <param name=\"room\" type=\"String\">Server side type is System.String</param>
                return proxies.chat.invoke.apply(proxies.chat, $.merge(["CreateChatRoom"], $.makeArray(arguments)));
            },
